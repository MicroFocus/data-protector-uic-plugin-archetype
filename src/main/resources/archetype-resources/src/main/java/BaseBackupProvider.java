...
public abstract class BaseBackupProvider extends BackupProvider implements BackupInterface, RestoreInterface {
	...
	protected void fullBackup(IProgressStatus status, ${pluginName}BackupRequest request, BackupContext context) {
	...
	protected abstract void doFullBackup(IProgressStatus status, ${pluginName}BackupRequest request, BackupContext context);

	protected void incrBackup(IProgressStatus status, ${pluginName}BackupRequest request, BackupContext context) {
	...
	protected abstract void doIncrBackup(IProgressStatus status, ${pluginName}BackupRequest request, BackupContext context, ${pluginName}LastBackupDetail lastBackupDetail);
	
	protected ${pluginName}LastBackupDetail getLastBackupDetail(IProgressStatus status, ${pluginName}BackupRequest request) {
	...
	protected void checkIncrBackupConstraint(IProgressStatus status, ${pluginName}LastBackupDetail lastBackupDetail) {
		...
		//TODO If you have additional validation to perform, add them directly here or override this method in ${pluginName}BackupProvider whichever is preferred.
	}

	protected BackupContext establishBackupContext(IProgressStatus status, ${pluginName}BackupRequest request) {
		try {
	...
	protected BackupContext getBackupContext(${pluginName}BackupRequest request) {
		...
		/// NOTE: You can add custom behaviors directly in this method or override this method in ${pluginName}BackupProvider whichever is preferred.
	...
	protected void sendFullBackup(IProgressStatus status, ${pluginName}BackupRequest request, BackupContext context) {
	...
	protected void sendIncrBackup(IProgressStatus status, ${pluginName}BackupRequest request, BackupContext context) {
	...
	protected ${pluginName}BackupRequest validateInput(IProgressStatus status, BackupRequest backupRequest) {
		try {
			...
			// in ${pluginName}BackupProvider whichever is preferred.
			return request;
		} catch (Exception e) {
	...
	protected ${pluginName}BackupRequest to${pluginName}BackupRequest(BackupRequest backupRequest) {
		try {
	...
	protected void receiveBackup(IProgressStatus status, ${pluginName}RestoreRequest request, RestoreContext restoreContext) {
	...
	protected abstract void doRestoreFullBackup(IProgressStatus status, ${pluginName}RestoreRequest request, RestoreContext restoreContext);

	protected void applyIncrementalBackupInSequence(IProgressStatus status, ${pluginName}RestoreRequest request, RestoreContext restoreContext) {
	...
	protected abstract void doRestoreIncrBackup(IProgressStatus status, ${pluginName}RestoreRequest request, RestoreContext restoreContext, File incrBackupDir);

	protected ${pluginName}RestoreRequest validateInput(IProgressStatus status, RestoreRequest restoreRequest) {
		try {
			// Validate the JSON parsing (deserialization) of the ${pluginName} specific part of the request
	...
	protected ${pluginName}RestoreRequest to${pluginName}RestoreRequest(RestoreRequest restoreRequest) {
		try {
	...
	protected RestoreContext establishRestoreContext(IProgressStatus status, ${pluginName}RestoreRequest request) {
		try {
	...
	protected RestoreContext getRestoreContext(${pluginName}RestoreRequest request) {
